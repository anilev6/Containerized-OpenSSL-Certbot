...
def certificates(country, state, locality, organization, cert_name, key_name, days, common_name):
    """
...
def get_certificates(env_file=False, days="365"):
    ...
    return certificates(country, state, locality, organization, cert_name, key_name, days, common_name)
